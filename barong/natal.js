document.addEventListener("DOMContentLoaded", function () {
  const rdyyThemeDirgahayuMobile = `
    ...
    .navbar-fixed-top {
        ...
        background: url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhACPmUqqQayaPu-MA0zG_iNivC5dIZZtIWBrIj2riDw9SYStr4YeLvXDUXlnvwky25jCEmUzGpOrZbu7YntxHSz3v-fE0btw8ncL7HNnziAT8C5A2gACvLWS8PLoShxB6MVt8uY2kx9y9qkx0VnpW0LS48KvP-aId7ofskEcBTyXqHN9uyr9fxVR50xw/s1600/barong-navbar-natal.png) bottom center no-repeat;
        background-size: cover;
    }
    </style>`;
  
  document.body.insertAdjacentHTML('afterbegin', rdyyThemeDirgahayuMobile);
  document.head.insertAdjacentHTML("beforeend", `<script src="https://cdn.jsdelivr.net/gh/rudywind/878group@main/salju.js"><\/script>`);
});
